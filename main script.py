...
# Here, replace the path to your client_secrets.json file
...
def search_youtube_video_id(track_name, artist_name):
    ...
    url = f"https://www.googleapis.com/youtube/v3/search?part=snippet&q={query}&key=YOUR_YOUTUBE_API_KEY"
...
playlist_id = "26BddaNesEUmdsptX7AcqO"                      # make sure this is 22 characters long
tracks = test_spotify_connection(playlist_id)

# Create a YouTube playlist
youtube_playlist_id = create_youtube_playlist("Playlist created without human intervention 22", "A playlist created via the YouTube API")
